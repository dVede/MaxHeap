...
public class BMTest {
    ...
    public static class BenchMarkState {
        ...
        private Heap<Integer> big1 = new Heap<>(new ArrayList<>(Arrays.asList(60, 15, 69, 127, 73, 141, 96, 70,
                54, 36, 113, 75, 94, 57, 146, 3, 20, 143, 80, 21, 55, 51, 28, 76, 62, 48, 67, 81, 52, 65, 122, 114,
                8, 130, 72, 46, 19, 139, 140, 32, 106)));

        private Heap<Integer> big2 = new Heap<>(new ArrayList<>(Arrays.asList(122, 196, 192, 136, 90, 33, 17,
                57, 65, 41, 126, 107, 129, 145, 199, 15, 15, 90, 130, 58, 149, 116, 115, 17, 60, 130, 118, 41, 26,
                36, 158, 147, 31, 150, 82, 120, 182, 99, 177, 47, 140, 102, 153, 69, 47, 152, 83, 61, 42, 13)));

        private Heap<Integer> small1 = new Heap<>(new ArrayList<>(Arrays.asList(60, 15, 69)));

        private Heap<Integer> small2 = new Heap<Integer>(new ArrayList<>(Arrays.asList(36, 45, 49)));
    ...
    public void createNewHeap(BenchMarkState state) {
        Heap<Integer> heap = new Heap<>(new ArrayList<>(Arrays.asList(60, 15, 69, 127, 73, 141, 96, 70,
                54, 36, 113, 75, 94, 57, 146, 3, 20, 143, 80, 21, 55, 51, 28, 76, 62, 48, 67, 81, 52, 65, 122, 114,
                8, 130, 72, 46, 19, 139, 140, 32, 106)));
    }
